    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests()
                    ...
                    .antMatchers(HttpMethod.POST, "/api/coupons/apply").hasAuthority("Normal") // Apply Coupon(Normal User)
//                    .antMatchers(HttpMethod.PUT, "/api/coupons/update/{code}").hasAuthority("Admin") // Update Coupon(Admin)
